<template>
  <v-container fluid>
    <div class="barCharts-page">
      <h1 class="page-title mt-10 mb-6">Bar Charts</h1>
      <v-row>
        <v-col cols="12" md="6">
              ...
              <v-row no-gutters>
                <v-col cols="12" class="my-auto">
                  <ApexChart
                    type="bar"
                    height="350"
                    :options="apexStuckBar.options"
                    :series="apexStuckBar.series">
                  </ApexChart>
                </v-col>
              </v-row>
            </v-card-text>
              ...
              <v-row no-gutters>
                <v-col cols="12" class="my-auto">
                  <ApexChart
                      type="bar"
                      height="350"
                      :options="apexBarWithImage.options"
                      :series="apexBarWithImage.series">
                  </ApexChart>
                </v-col>
              </v-row>
            </v-card-text>
    ...
    return {
      ...
      apexStuckBar: {
        ...
        options: {
          ...
          colors: [config.light.success, config.light.primary, config.light.secondary, config.light.info, config.light.warning],
          legend: {
            show: false
          },
          xaxis: {
