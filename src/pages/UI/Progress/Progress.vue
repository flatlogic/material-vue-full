          ...
          <v-card-text class="pa-5 pt-0">
            ...
            <template v-for="prog in progress">
              <v-progress-linear
                ...
                :color="prog.color"
              ></v-progress-linear>
              <div class="w-100 mb-4" v-bind:key="prog.color"></div>
            </template>
          </v-card-text>
        </v-card>
      </v-col>
  ...
  export default {
    ...
    mounted () {
      this.interval = setInterval(() => {
        this.value === 100 ? this.value = 0 : this.value += 5}, 1000)
    },
